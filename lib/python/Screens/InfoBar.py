...
from Screens.InfoBarGenerics import InfoBarShowHide, \
	...
	InfoBarSubtitleSupport, InfoBarPiP, InfoBarPlugins, InfoBarServiceErrorPopupSupport, InfoBarJobman, InfoBarZoom, InfoBarHandleBsod, \
...
class InfoBar(InfoBarBase, InfoBarShowHide,
	...
	InfoBarPiP, InfoBarPlugins, InfoBarSubtitleSupport, InfoBarServiceErrorPopupSupport, InfoBarJobman, InfoBarZoom, InfoBarHandleBsod,
	...
	def __init__(self, session):
		...
		for x in HelpableScreen, \
				...
				InfoBarTeletextPlugin, InfoBarExtensions, InfoBarPiP, InfoBarSubtitleSupport, InfoBarJobman, InfoBarZoom, InfoBarHandleBsod, \
