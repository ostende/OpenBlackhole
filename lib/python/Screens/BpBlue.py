...
class DeliteBluePanel(Screen):
	skin = """
	<screen name="DeliteBluePanel" position="center,center" size="1000,720"  title="OpenBlackHole Blue Panel" flags="wfNoBorder">
        <ePixmap position="339,170" zPosition="3" size="60,40" pixmap="skin_default/buttons/key_ok.png" alphatest="blend" transparent="1" />
        <eLabel text="OpenBlackHole Blue Panel" position="80,30" size="800,38" font="Regular;34" halign="left" transparent="1"/>
        ...
        <widget name="Ilab1" position="79,257" size="350,28" font="Regular;24" foregroundColor="orange" zPosition="2" transparent="1"/>
        <widget name="Ilab2" position="79,290" size="350,28" font="Regular;24" zPosition="2" transparent="1"/>
        <widget name="Ilab3" position="79,315" size="350,28" font="Regular;24" foregroundColor="orange" zPosition="2" transparent="1"/>
...
class Nab_DoStartCam(Screen):
	skin = """
	<screen position="390,100" size="484,250" title="openBlackHole Cam Starter" flags="wfNoBorder">
...
class BhsysInfo(Screen):
	skin = """
	<screen position="center,center" size="800,600" title="OpenBlackHole Info" flags="wfNoBorder">
...
class BhEpgPanel(Screen):
	skin = """
	<screen position="center,center" size="600,400" title="OpenBlackHole EPG Panel">
